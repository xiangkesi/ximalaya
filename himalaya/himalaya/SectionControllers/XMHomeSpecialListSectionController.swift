//
//  XMHomeSpecialListSectionController.swift
//  himalaya
//
...
class XMHomeSpecialListSectionController: ListSectionController {
    ...
    override func cellForItem(at index: Int) -> UICollectionViewCell {
         if index == 0 {
             guard let cell: XMHomeTopTitleCell = collectionContext?.dequeueReusableCell(for: self, at: index) else {
                    ...
                    guard let cell: XMHomeRadioSectionCollectionViewCell = collectionContext?.dequeueReusableCell(for: self, at: index) else {
                        fatalError()
                    }
...
extension XMHomeSpecialListSectionController: ListAdapterDataSource {
...
class XMHomeRadioSectionCollectionViewCell: XMCommonCollectionViewCell {
